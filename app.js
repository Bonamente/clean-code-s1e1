...
var taskInput=document.querySelector('.task-creation__task');//Add a new task.
var addButton=document.querySelector('.task-creation__button');//first button
...
var createNewTaskElement=function(taskString){
    ...
    label.classList.add("task-label", "task-text");
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task-item--editable");
    ...
    listItem.classList.toggle("task-item--editable");
